...
y_pred_init = pd.read_csv('./pred/Seurat/Human3_Seurat_pred.csv', header=None).values.reshape(-1).astype('int')
...
np.savez("./results/scAce_enhance_Seurat_human3.npz", ARI=ari, NMI=nmi, K=K, Embedding=embedding_all,
