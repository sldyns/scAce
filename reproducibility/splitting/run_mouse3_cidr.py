...
y_pred_init = pd.read_csv('./pred/CIDR/Mouse3_CIDR_pred.csv', header=None).values.reshape(-1).astype('int')
...
np.savez("./results/scAce_enhance_CIDR_mouse3.npz", ARI=ari, NMI=nmi, K=K, Embedding=embedding_all,
