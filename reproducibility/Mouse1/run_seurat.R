...
ARI = adjustedRandIndex(cluster_l, sctype)
NMI = col_NMI(cluster_l, sctype)
...
directory<-"../data/sample/data_Mouse1"
files <- list.files(directory, pattern = "^Mouse1_.*\\.h5$", full.names = TRUE)
