...
np.savez("results/scVI_wo_sample.npz", ARI=ari, NMI=nmi, K=k, Clusters=pred, Embedding=embedding)
...
np.savez("results/scVI_with_sample.npz", ARI=ari_all, NMI=nmi_all, K=k_all)