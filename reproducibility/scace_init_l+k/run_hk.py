...
np.savez("results/scAce_kmeans_kidney.npz", ARI=ari, NMI=nmi, Embedding=emb_all, Clusters=pred_all, Labels=y)
...
np.savez("results/scAce_louvain_kidney.npz", ARI=ari, NMI=nmi, Embedding=emb_all, Clusters=pred_all, Labels=y)