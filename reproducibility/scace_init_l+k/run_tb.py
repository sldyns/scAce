...
np.savez("results/scAce_kmeans_turtle.npz", ARI=ari, NMI=nmi, Embedding=emb_all, Clusters=pred_all, Labels=y)
...
np.savez("results/scAce_louvain_turtle.npz", ARI=ari, NMI=nmi, Embedding=emb_all, Clusters=pred_all, Labels=y)
