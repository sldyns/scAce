...
class scDeepClusterBatch(nn.Module):
    ...
    def pretrain_autoencoder(self, X, B, X_raw, size_factor, batch_size=256, lr=0.001, epochs=400, ae_save=True,
    ...
    def fit(self, X, B, X_raw, size_factor, n_clusters, init_centroid=None, y=None, y_pred_init=None, lr=1.,
            batch_size=256,
