...
np.savez("results/DESC_wo_sample.npz", ARI=ari, NMI=nmi, K=k, Embedding=embedding, Clusters=y_pred, Time_use=run_time)
...
for i in range(total_rounds):
    ...
    true_all.append(np.array(adata.obs['celltype']).squeeze())
...
np.savez("results/DESC_with_sample.npz", ARI=ari_all, NMI=nmi_all, K=k_all, Clusters=pred_all,
         Labels=true_all)
